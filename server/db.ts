...
const demoSnapshot = {
  warnings: [
    ...
    },
    {
      ...
      warningText: "Keep emergency access roads, drains and culverts clear.",
      recommendedPrecautions: "Move vehicles from marked drains. Keep a torch ready. Keep your phone charged.",
      issuedAt: new Date("2026-09-22T04:30:00Z"),
      validFrom: new Date("2026-09-22T04:30:00Z"),
