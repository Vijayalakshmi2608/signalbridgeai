...
const navGroups = [
  ...
  { label: "Personal", items: [{ href: "/profile", label: "Emergency profile", icon: ShieldCheck }, { href: "/safety", label: "Safety status", icon: RadioTower }, { href: "/offline", label: "Offline mode", icon: WifiOff }] },
];
